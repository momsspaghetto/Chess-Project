...
// When I first met you, you became an object of admiration but I knew I was too weak to have you so I didn’t do anything. But I knew that I had moments where my subconscious overrid me. But I remember that the though my of you killed my anxious flare ups and back then I didn’t know how to deal with it besides maintains what I had before the stakes could raise. But when you left it disregulated me to the point where I felt a compulsion to always move forward detached, because I was so innately worthless that building a wall of hard power was the only way to keep myself safe from the world, and maybe be worthy of you one day. And that the flare ups got so bad that I had to turn them into aggression, but I learned to channel my emotions by funneling them as long as my mind could stay detached from them and use them as fuel. Recent events carved into the bit of ego I had as a general buffer to the point where it subconsciously reactivated the original intensity of the chase, but I guess I acquired enough power that my mind signed off on more direct moves having higher probabilities of success. But now I feel warm inside again  and I don’t know how to operate like this because I’ve been used devaluing everything to stay sharp, but I can’t devalue you. But I don’t want to keep you attached against your will, but I also don’t want to go back to my old state, but I can for you. But I also have nothing tying me down in Tampa. //
